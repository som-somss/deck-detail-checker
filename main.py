...
class App(tk.Tk):
 def __init__(self):
  super().__init__();self.title("DECK 상세도 자동 검토기 V8");self.geometry("1250x720");self.d=tk.StringVar();self.x=tk.StringVar();self.err=tk.BooleanVar(value=True);self.rows=[];self.ui()
 def ui(self):
